...
class PeopleController < ApplicationController
    ...
    def index
        attempt do
#            @people = Person.paginate(:page => params[:page], :per_page => 50).order('last_name, first_name').readonly
            @people = Person.page(params[:page]).per_page(50).order('last_name, first_name').readonly
